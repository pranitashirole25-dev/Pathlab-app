...
exports.getBookingHistory = exports.cancelBooking = exports.createBooking = void 0;
...
const createBooking = async (req, res) => {
    ...
    try {
        ...
        const patientRes = await (0, db_1.query)('SELECT dob FROM patients WHERE id = $1', [patientId]);
        ...
        const testsRes = await (0, db_1.query)(`SELECT SUM(price) as subtotal FROM catalog_tests WHERE id = ANY($1::int[])`, [testIds]);
        ...
        // 4. Insert Booking
        const bookingResult = await (0, db_1.query)(`INSERT INTO bookings (user_id, patient_id, collection_type, address_id, subtotal, discount_amount, home_visit_fee, total_amount) 
       VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING id`, [userId, patientId, collectionType, addressId || null, subtotal, discountAmount, homeVisitFee, totalAmount]);
        const bookingId = bookingResult.rows[0].id;
        // 5. Insert booking_tests
        for (const testId of testIds) {
            await (0, db_1.query)(`INSERT INTO booking_tests (booking_id, test_id, price_at_booking) 
         SELECT $1, id, price FROM catalog_tests WHERE id = $2`, [bookingId, testId]);
        }
        res.status(201).json({
...
const cancelBooking = async (req, res) => {
    ...
    try {
        ...
        const apptRes = await (0, db_1.query)(`SELECT a.scheduled_date, a.scheduled_time, a.actual_arrival_time, b.home_visit_fee, b.total_amount 
       FROM bookings b 
       ...
       WHERE b.id = $1`, [id]);
        ...
        // Update booking
        await (0, db_1.query)("UPDATE bookings SET status = 'CANCELLED', cancellation_fee = $1, payment_status = 'REFUNDED' WHERE id = $2", [cancellationFee, id]);
...
const getBookingHistory = async (req, res) => {
    ...
    try {
        const history = await (0, db_1.query)("SELECT b.id, b.created_at, b.status, b.total_amount, p.first_name, p.last_name, p.dob, r.local_file_path as report_url " +
            "FROM bookings b " +
